...
const ResumePage = ({ content, industry, pentaContact }) => {
    ...
    useEffect(()=>{
        ...
        console.log('sum of content Height : ', summaryHeight + headerHeight + topPageHeight + educationHeight+certifHeight+workHeight+projectHeight+skillsHeight+toolsHeight+langHeight)

    },[pageHeight,summaryHeight,topPageHeight,headerHeight, educationHeight, certifHeight,workHeight,projectHeight,skillsHeight,toolsHeight,langHeight])
